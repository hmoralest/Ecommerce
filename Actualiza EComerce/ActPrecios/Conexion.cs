...
namespace ActPrecios
{
    class Conexion
    {
        ...
        /// <summary>
        /// método que obtiene la Conexión para Obtener datos de Precios
        /// </summary>
        /// <returns>SQL Server Conexión - obtener Precios</returns>
        public SqlConnection getConexionSQL()
        {
            ...
            using (SqlConnection con = getConexionLog())
            {
                try
                {
                    ...
                    da.SelectCommand.Parameters.Add("@Id", SqlDbType.VarChar).Value = "05";
