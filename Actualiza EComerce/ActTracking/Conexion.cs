...
{ 
    ...
    class Conexion
    {
        ...
        /// <summary>
        /// método que obtiene la Conexión para Obtener datos de Tracking
        /// </summary>
        /// <returns>SQL Server Conexión - obtener Tracking</returns>
        public SqlConnection getConexionSQL()
        {
            ...
            using (SqlConnection con = getConexionLog())
            {
                try
                {
                    ...
                    da.SelectCommand.Parameters.Add("@Id", SqlDbType.VarChar).Value = "08";
